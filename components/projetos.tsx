...
export default function Cards(){
    return(
        ...
        <div className="cardname">Site de Produtos</div>
         <div className="cardresume">Site feito com Front-End feito em React, que conta com sistema de Login Utilizando o Banco de Dados da Google(Firebase), Back-End Desenvoldido em Node.js/Postgres</div>
